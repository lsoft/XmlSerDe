...
namespace XmlSerDe.Generator.Producer
{
    ...
    ///
    /// Цена измерена (docs/dispatch-cost.md): на настоящем стоке незапечатанный
    /// тип стоит около +4% на net10.0 и в пределах шума на net472, а на
    /// полиморфном сайте - до 1.8x. Поэтому это предупреждение, а не ошибка:
    /// код работает и так, просто медленнее, чем мог бы.
    /// </summary>
